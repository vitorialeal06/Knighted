...
class Abertura(models.Model):
    ...
    movimento = models.TextField(blank=False, null=True)
...
class Jogador(models.Model):
    ...
    elo = models.TextField(blank=False, null=True)
...
class Partida(models.Model):
    ...
    id_abertura_brancas = models.ForeignKey(Abertura, models.DO_NOTHING, db_column='id_abertura_brancas', blank=True, null=True, related_name='partidas_brancas')
    id_abertura_pretas = models.ForeignKey(Abertura, models.DO_NOTHING, db_column='id_abertura_pretas', blank=True, null=True, related_name='partidas_pretas')
...
class Torneio(models.Model):
    nome_torneio = models.TextField(blank=True, null=True)
